...
The goal of **meta.arrR** is to simulate metaecosystems of artificial reefs.

## Installation

You can install the development version from [GitHub](https://github.com/) with (you need a PAT for this though):
